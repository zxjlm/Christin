  ...
  graphLayout_force: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          max: 200,
          description:
            '节点在布局中所占空间大小（直径），用于碰撞检测，若设置为0，则使用节点本身的大小',
        },
        {
          component: Slider,
          label: 'nodeSpacing',
        ...
        },
        {
          ...
          step: 0.001,
          description:
            '当前迭代的收敛阈值，默认值为0.3，该值设置的越大，迭代越容易收敛，但布局质量不高',
        },
        {
          component: Slider,
          label: 'alphaDecay',
  ...
  graphLayout_gForce: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'gpuEnabled',
          labelZh: 'GPU并行计算',
          key: 'layoutConfig.gpuEnabled',
          defaultValue: false,
          size: 'small',
          description: '开启GPU并行计算后, 能够极大地加快渲染的效率(请确认电脑支持gpu). 默认不开启',
        },
        {
          component: Switch,
          isSwitch: true,
          label: 'workerEnabled',
          labelZh: '舒缓模式',
          key: 'layoutConfig.workerEnabled',
          defaultValue: false,
          size: 'small',
          description: '是否启用 web-worker 以防布局计算时间过长阻塞页面交互. 默认不开启',
        },
        {
          component: Slider,
          label: 'maxIteration',
          ...
          step: 1,
          description:
            '最大迭代次数。当迭代次数超过该值，但平均移动长度仍然没有达到 minMovement，也将强制停止迭代. 默认值为500',
        },
      ],
    },
  ],
